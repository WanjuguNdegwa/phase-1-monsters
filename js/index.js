...
const getMonsters = (a) => {
    ...
    createMonsterCard = (a) => {
        ...
        (c.innerHTML = `${a.name}`), (d.innerHTML = `Age: ${a.age}`), (e.innerHTML = `Bio: ${a.description}`), b.appendChild(c), b.appendChild(d), b.appendChild(e), document.querySelector("#monster-container").appendChild(b);
    },
    createMonsterForm = () => {
